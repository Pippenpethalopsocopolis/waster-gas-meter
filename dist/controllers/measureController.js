...
export const confirmMeasureValue = async (req, res) => {
...
export const listMeasures = async (req, res) => {
    ...
    const measures = await findMeasuresByCustomerCode(customer_code, measure_type ? measure_type.toUpperCase() : undefined);
